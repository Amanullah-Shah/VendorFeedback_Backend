...
namespace feedback.Migrations
{
    ...
    [Migration("20240726105020_initNewChange")]
    partial class initNewChange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("feedback.Models.FeedbackDetail", b =>
                {
                    b.HasOne("feedback.Models.Service_answer", "Answer")
                        .WithMany()
                        .HasForeignKey("AnswerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("feedback.Models.FeedbackMaster", "FeedbackMaster")
                    ...
                    b.HasOne("feedback.Models.suggestion_answer", "suggestion_answer")
                        .WithMany()
